...
void help_screen_draw(void) {
	...
	CenteredSentence(FONT4, 30, 789, 0, 100, FOREST_GREEN, 0, "How to use this system", DONT_ERASE);
	char * sentences[] = {
		"1. Home Menu", 
					"   - To create a new shopping list, tap on the \"Start Shopping List\"",
					"		button",
